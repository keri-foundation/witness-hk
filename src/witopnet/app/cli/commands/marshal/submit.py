...
parser.add_argument(
    "--aeid",
    help="qualified base64 of non-transferable identifier prefix for  authentication "
    "and encryption of secrets in keystore",
    default=None,
)
parser.add_argument(
    "--force",
...
class InceptDoer(doing.DoDoer):
    ...
    def __init__(self, name, base, alias, bran, force):
        """
        Parameters:
            name (str): keystore name and file location of the KERI keystore
            base (str): optional path prefix for the keystore location
            alias (str): human-readable alias for the identifier to submit
            bran (str | None): 21-character passcode for keystore encryption
